...
const configFile = ".triebwerk.json"

// watchConfig is the root of .triebwerk.json.
...
// loadConfig reads .triebwerk.json from dir. Returns an empty config if the
...
// saveConfig writes cfg to .triebwerk.json in dir (pretty-printed).
