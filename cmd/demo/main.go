				...
				if selected < len(switcher.Children()) {
					...
					case 32:
						dialog := ui.NewBuilder().
							...
							Class("dialog").
							VFlex("dialog-content", 1).
							Static("", "Do you really want to do this?").
							Flex("dialog-buttons", "end", 2).
							Button("btn-yes", "YES").
							Button("btn-no", "NO").
							End().
							End().
...
func box(builder *Builder) {
	builder.VFlex("box-demo", 1).Padding(1).
		Static("box-title", "Box Widget Demo").Padding(0, 0, 1, 0).
		HRule("thin").
		VFlex("box-examples", 1).
...
func canvas(builder *Builder) {
	...
	builder.VFlex("canvas-demo", 1).Padding(1).
...
func checkbox(builder *Builder) {
	builder.VFlex("checkbox-demo", 1).Padding(1, 2).
...
func comboDemo(builder *Builder) {
	...
	builder.Flex("combo-demo", "start", 1).Flag(FlagVertical).Padding(1, 2).
...
func collapsibleDemo(builder *Builder) {
	builder.VFlex("collapsible-demo", 1).Padding(1, 2).
		...
		VFlex("col-basic-content", 1).Padding(0, 1).
		...
		VFlex("col-inputs-content", 1).Padding(0, 1).
		Static("", "Name:").
		Input("col-name", "").
		Static("", "Email:").
		Input("col-email", "").
...
func deckDemo(builder *Builder, theme *Theme) {
	...
	builder.VFlex("deck-wrapper", 0).Padding(0, 1).
...
func digits(builder *Builder) {
	builder.VFlex("digits-demo", 1).Padding(1).
		Static("digits-title", "Digits Widget Demo").Padding(0, 0, 1, 0).
		Flex("digits-content", "center", 1).
		Digits("digits", "12:34").
		End().
...
func dropdown(builder *Builder) {
	builder.Flex("select-demo", "start", 1).Flag(FlagVertical).Padding(1, 2).
...
func filterDemo(builder *Builder) {
	...
	builder.VFlex("filter-demo", 1).Padding(1, 2).
...
func form(builder *Builder) {
	...
	builder.Flex("form-demo", "start", 1).Flag(FlagVertical).Margin(2).Border("", "round").Padding(2).
		...
		End().
		End().
		Flex("form-buttons", "start", 1).Margin(1).
...
func marqueeDemo(builder *Builder) {
	builder.VFlex("marquee-demo", 1).Padding(1, 2).
		...
		Spacer().Hint(-1, 0).
		Flex("marquee-controls", "center", 4).Padding(1, 0, 0, 0).
...
func shimmerDemo(builder *Builder) {
	builder.VFlex("shimmer-demo", 1).Padding(1, 2).
		...
		Spacer().Hint(-1, 0).
		Flex("shimmer-controls", "center", 4).Padding(1, 0, 0, 0).
...
func progress(builder *Builder) {
	builder.VFlex("progress-demo", 1).Padding(1).
		Static("progress-title", "Progress Widget Demo").Padding(0, 0, 1, 0).
		VFlex("progress-content", 1)
...
func scanner(builder *Builder) {
	builder.VFlex("scanner-container", 1).Padding(1).
		...
		Flex("scanner-flex", "center", 1).Flag(FlagVertical).
...
func tabs(builder *Builder) {
	builder.VFlex("tabs-demo", 1).Padding(1, 2).
...
func terminalDemo(builder *Builder) {
	...
	builder.VFlex("terminal-pane", 0).Hint(0, -1).Padding(0, 1).
...
func typeaheadDemo(builder *Builder) {
	...
	builder.VFlex("typeahead-demo", 1).Padding(1, 2).
...
func tilesDemo(builder *Builder) {
	...
	builder.VFlex("tiles-demo", 0).Padding(0, 2).
...
func treeFSDemo(builder *Builder) {
	...
	builder.VFlex("tree-fs-demo", 0).
		// Toolbar: Up button + current root path
		Flex("tree-fs-toolbar", "center", 1).Padding(0, 1).
...
func typewriterDemo(builder *Builder) {
	...
	builder.VFlex("tw-demo", 1).Padding(1, 2).
		...
		Typewriter("tw").
		Spacer().Hint(-1, 0).
		Flex("tw-controls", "center", 4).Padding(1, 0, 0, 0).
...
func valueDemo(builder *Builder) {
	builder.VFlex("value-demo", 1).Padding(1, 2).
	...
	builder.Spacer().Size(0, 1)
	builder.Flex("val-digits-row", "center", 0).
		Add(digits).
		End()
...
func viewport(builder *Builder) {
	builder.VFlex("viewport-demo", 1).Padding(1, 2).
...
func sparklineDemo(builder *Builder) {
	...
	builder.VFlex("sparkline-demo", 1).Padding(1, 2).
...
func heatmapDemo(builder *Builder) {
	...
	builder.VFlex("heatmap-demo", 1).Padding(1, 2).
...
func barChartDemo(builder *Builder) {
	...
	builder.VFlex("bar-chart-demo", 1).Padding(1, 2).
...
func breadcrumbDemo(builder *Builder) {
	...
	builder.VFlex("breadcrumb-demo", 1).Padding(1, 2).
		...
		Flex("bc-controls", "center", 2).Padding(1, 0, 0, 0).
		Button("bc-push", "Push").
		Button("bc-pop", "Pop").
...
func commandsDemo(b *Builder) {
	b.VFlex("commands-demo", 1).Padding(1).
