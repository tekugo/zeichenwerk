...
func dashboardScreen(theme *core.Theme) core.Widget {
	...
	w := Build(theme,
		VFlex("dashboard", "", core.Stretch, 0,
			Padding(1, 2),
			// Title row
			HFlex("dash-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			// KPI cards
			HFlex("kpi-row", "", core.Stretch, 2,
				Padding(0, 0, 1, 0),
				VFlex("kpi-cpu", "", core.Start, 0,
			...
			Grid("dash-mid", "", []int{0}, []int{-2, -1}, false,
				...
				Cell(1, 0, 1, 1,
					VFlex("alerts-pane", "", core.Stretch, 0,
						Border("", "round"),
			...
			// Activity log
			VFlex("activity-pane", "", core.Stretch, 0,
...
func userAdminScreen(theme *core.Theme) core.Widget {
	...
	w := Build(theme,
		VFlex("user-admin", "", core.Stretch, 0,
			Padding(1, 2),
			HFlex("ua-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			HRule("", "thin", Padding(0, 0, 1, 0)),
			HFlex("ua-toolbar", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			Grid("ua-body", "", []int{-1}, []int{-3, -2}, false,
				...
				Cell(0, 0, 1, 1,
					VFlex("ua-list-pane", "", core.Stretch, 0,
						Border("", "round"),
				...
				Cell(1, 0, 1, 1,
					VFlex("ua-detail-pane", "", core.Stretch, 0,
						Border("", "round"),
						...
						HFlex("ua-detail-btns", "", core.End, 2,
							Padding(1),
...
func logMonitorScreen(theme *core.Theme) core.Widget {
	...
	w := Build(theme,
		VFlex("log-monitor", "", core.Stretch, 0,
			Padding(1, 2),
			HFlex("log-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			HRule("", "thin", Padding(0, 0, 1, 0)),
			HFlex("log-toolbar", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			Grid("log-body", "", []int{-1}, []int{-3, -1}, false,
				Hint(0, -1), Border("none"),
				Cell(0, 0, 1, 1,
					VFlex("log-view-pane", "", core.Stretch, 0,
						Border("", "round"),
				...
				Cell(1, 0, 1, 1,
					VFlex("log-stats-pane", "", core.Stretch, 0,
						Border("", "round"),
...
func processScreen(theme *core.Theme) core.Widget {
	...
	w := Build(theme,
		VFlex("process-mgr", "", core.Stretch, 0,
			Padding(1, 2),
			HFlex("proc-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			HRule("", "thin", Padding(0, 0, 1, 0)),
			HFlex("proc-res-row", "", core.Stretch, 4,
				Padding(0, 0, 1, 0),
				VFlex("proc-cpu-card", "", core.Stretch, 0,
				...
				VFlex("proc-mem-card", "", core.Stretch, 0,
					Border("", "round"), Padding(0, 2),
				...
				Spacer("", Hint(-1, 0)),
				VFlex("proc-info-card", "", core.Stretch, 0,
					Border("", "round"), Padding(0, 2),
			...
			HFlex("proc-toolbar", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			VFlex("proc-table-pane", "", core.Stretch, 0,
				Border("", "round"), Hint(0, -1),
...
func dataEntryScreen(theme *core.Theme) core.Widget {
	...
	w := Build(theme,
		VFlex("data-entry", "", core.Stretch, 0,
			Padding(1, 2),
			HFlex("de-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			Grid("de-body", "", []int{0}, []int{-1, -1}, false,
				Hint(0, -1),
				Cell(0, 0, 1, 1,
					VFlex("de-form-col", "", core.Stretch, 0,
						Collapsible("de-cust-section", "", "  ① Customer Information", true,
							HFlex("de-cust-content", "", core.Stretch, 0,
								Padding(0, 2),
						...
						Collapsible("de-ship-section", "", "  ② Shipping Details", true,
							VFlex("de-ship-content", "", core.Stretch, 0,
								Padding(0, 2),
						...
						Collapsible("de-pay-section", "", "  ③ Payment & Terms", false,
							VFlex("de-pay-content", "", core.Stretch, 0,
								Padding(0, 2),
				...
				Cell(1, 0, 1, 1,
					VFlex("de-items-col", "", core.Stretch, 0,
						Padding(0, 0, 0, 2),
...
func codeEditorScreen(theme *core.Theme) core.Widget {
	mainGoContent := []string{
		...
		`        Flex("root", false, core.Stretch, 0).`,
	...
	w := Build(theme,
		VFlex("code-editor", "", core.Stretch, 0,
			Padding(1, 2),
			HFlex("ce-hdr", "", core.Center, 2,
				Padding(0, 0, 1, 0),
			...
			Grid("ce-body", "", []int{-1}, []int{26, -1}, false,
				Hint(0, -1), Border("none"),
				Cell(0, 0, 1, 1,
					VFlex("ce-tree-pane", "", core.Stretch, 0,
						Border("", "round"),
				...
				Cell(1, 0, 1, 1,
					VFlex("ce-edit-col", "", core.Stretch, 0,
						Hint(0, -1),
						Tabs("ce-tabs", ""),
