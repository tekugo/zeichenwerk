...
func TokyoNightTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("tabs").WithColors("$fg0", "$bg0"),
		NewStyle("tabs/highlight").WithColors("$fg0", "$bg0"),
		NewStyle("tabs/highlight:focused").WithColors("$bg0", "$orange"),
		NewStyle("tabs/line:focused").WithForeground("$blue"),
		NewStyle("tabs/line-highlight").WithForeground("$orange"),
		NewStyle("tabs/line-highlight:focused").WithForeground("$orange"),
