...
func TokyoNightTheme() Theme {
	...
	theme.Set("list", NewStyle("", ""))
	theme.Set("list:focus", NewStyle("", ""))
	theme.Set("list:highlight", NewStyle("$bg", "$red"))
	theme.Set("list:highlight-blurred", NewStyle("$bg", "$comments"))
	...
	theme.Set("tabs:focus-highlight", NewStyle("$bg", "$cyan"))
	theme.Set("tabs:focus-highlight-line", NewStyle("$cyan", ""))
