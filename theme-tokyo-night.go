...
func TokyoNightTheme() Theme {
	...
	theme.Set("list/highlight:focus", NewStyle("$bg", "$red"))
	theme.Set("list/highlight", NewStyle("$bg", "$comments"))
	theme.Set("progress-bar", NewStyle("$comments", "").SetRender("unicode"))
	theme.Set("scroller", NewStyle("fg", "$bg3"))
	theme.Set("progress-bar/bar", NewStyle("$orange", ""))
	theme.Set("tabs/highlight", NewStyle("$bg", "$orange"))
	theme.Set("tabs/highlight-line", NewStyle("$orange", ""))
	theme.Set("tabs/line:focus", NewStyle("$blue", ""))
	theme.Set("tabs/highlight:focus", NewStyle("$bg", "$cyan"))
	theme.Set("tabs/highlight-line:focus", NewStyle("$cyan", ""))
