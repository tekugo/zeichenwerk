...
func GruvboxDarkTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("button").WithColors("$bg0", "$yellow").WithBorder("lines").WithPadding(0, 2),
		...
		NewStyle("list/highlight").WithColors("$bg0", "$bg3"),
		...
		NewStyle("input:focused").WithColors("$fg0", "$bg0"),
		NewStyle("typeahead").WithColors("$fg0", "$bg1").WithCursor("*bar"),
		NewStyle("typeahead:focused").WithColors("$fg0", "$bg0"),
		NewStyle("typeahead/suggestion").WithColors("$fg2", "$bg1"),
		NewStyle("typeahead/suggestion:focused").WithColors("$fg2", "$bg0"),
		NewStyle("rule"),
		...
		NewStyle("select:focused").WithColors("$fg0", "$bg0"),
		...
		NewStyle("table/highlight").WithColors("$bg0", "$bg3"),
		...
		NewStyle("tree/highlight").WithColors("$bg0", "$bg3"),
...
func GruvboxLightTheme() *Theme {
	...
	t.SetStyles(
		NewStyle("").WithColors("$fg1", "$bg0").WithMargin(0).WithPadding(0),
		NewStyle("box").WithBorder("thin"),
		NewStyle("button").WithColors("$bg0", "$orange").WithBorder("lines").WithPadding(0, 2),
