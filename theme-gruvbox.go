...
func GruvboxDarkTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("bar-chart/s0").WithColors("$bg0", "$blue"),
		NewStyle("bar-chart/s1").WithColors("$bg0", "$green"),
		NewStyle("bar-chart/s2").WithColors("$bg0", "$orange"),
		NewStyle("bar-chart/s3").WithColors("$bg0", "$purple"),
		NewStyle("bar-chart/s4").WithColors("$bg0", "$aqua"),
		NewStyle("bar-chart/s5").WithColors("$bg0", "$yellow"),
		NewStyle("bar-chart/s6").WithColors("$bg0", "$red"),
		NewStyle("bar-chart/s7").WithColors("$bg0", "$blue_dim"),
...
func GruvboxLightTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("sparkline/high").WithColors("$orange", "$bg0"),
		NewStyle("bar-chart").WithColors("$fg1", "$bg0"),
		NewStyle("bar-chart/s0").WithColors("$fg0", "$blue_dim"),
		NewStyle("bar-chart/s1").WithColors("$fg0", "$green_dim"),
		NewStyle("bar-chart/s2").WithColors("$fg0", "$orange_dim"),
		NewStyle("bar-chart/s3").WithColors("$fg0", "$purple_dim"),
		NewStyle("bar-chart/s4").WithColors("$fg0", "$aqua_dim"),
		NewStyle("bar-chart/s5").WithColors("$fg0", "$yellow_dim"),
		NewStyle("bar-chart/s6").WithColors("$fg0", "$red_dim"),
		NewStyle("bar-chart/s7").WithColors("$fg0", "$blue"),
