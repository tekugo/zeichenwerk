...
func LipstickTheme() *Theme {
	...
	t.AddStyles(
		...
		NewStyle("rule"),
		NewStyle("marquee").WithColors("$fuchsia", "$bg0"),
		NewStyle("shimmer").WithColors("$fg2", "$bg0"),
		NewStyle("shimmer/band").WithForeground("$fuchsia"),
		...
		NewStyle("bar-chart/s2").WithColors("$indigo", "$bg0"),
		NewStyle("bar-chart/s3").WithColors("$yellow", "$bg0"),
		NewStyle("bar-chart/s4").WithColors("$cyan", "$bg0"),
		NewStyle("bar-chart/s5").WithColors("$pink", "$bg0"),
		NewStyle("bar-chart/s6").WithColors("$red", "$bg0"),
		NewStyle("bar-chart/s7").WithColors("$purple", "$bg0"),
		...
		NewStyle("breadcrumb/segment:focused").WithColors("$bg0", "$fuchsia").WithFont("bold"),
		...
		NewStyle("tiles:focused").WithBorder("round $fuchsia"),
