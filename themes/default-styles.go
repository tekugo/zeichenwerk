...
func AddDefaultStyles(theme *Theme) {
	theme.AddStyles(
		...
		NewStyle("radio").WithColors("$fg1", ""),
		NewStyle("radio:disabled").WithColors("$bg3", ""),
		NewStyle("radio:focused").WithColors("$fg0", ""),
		NewStyle("radio:hovered").WithColors("$aqua", ""),
		NewStyle("radio/selected").WithColors("$cyan", ""),
		NewStyle("radio/selected:focused").WithColors("$bg0", "$cyan"),
		NewStyle("slider").WithColors("$fg3", ""),
		NewStyle("slider:disabled").WithColors("$bg3", ""),
		NewStyle("slider:focused").WithForeground("$cyan"),
		NewStyle("slider:hovered").WithColors("$aqua", ""),
		...
		NewStyle("colorpanel.dialog").WithColors("$fg1", "$bg2").WithBorder("thin"),
		NewStyle("colorpanel.dialog/title").WithColors("$aqua", "$bg2").WithFont("bold"),
		NewStyle("previewpanel").WithColors("$fg1", "$bg1").WithBorder("thin"),
		NewStyle("previewpanel/title").WithColors("$aqua", "$bg1").WithFont("bold"),
		NewStyle("previewpanel.dialog").WithColors("$fg1", "$bg2").WithBorder("thin"),
		NewStyle("previewpanel.dialog/title").WithColors("$aqua", "$bg2").WithFont("bold"),
		...
		NewStyle("colorpicker.dialog/contrast.ok").WithColors("$green", "$bg2"),
		NewStyle("colorpicker.dialog/contrast.warn").WithColors("$red", "$bg2"),
		NewStyle("input.error").WithColors("$bg0", "$red"),
		NewStyle("checkbox.dialog").WithColors("$fg1", "$bg2"),
		NewStyle("checkbox.dialog:disabled").WithColors("$bg3", "$bg2"),
		NewStyle("checkbox.dialog:focused").WithColors("$cyan", "$bg2"),
		NewStyle("checkbox.dialog:hovered").WithColors("$aqua", "$bg2"),
		NewStyle("form-group.dialog").WithColors("$fg1", "$bg2"),
		NewStyle("list.dialog").WithColors("$fg1", "$bg2"),
		NewStyle("list.dialog/highlight").WithColors("$bg0", "$fg2"),
		NewStyle("list.dialog/highlight:focused").WithColors("$bg0", "$cyan"),
	)
}
