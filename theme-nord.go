...
func NordTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("button").WithColors("$bg0", "$frost3").WithBorder("lines").WithPadding(0, 2),
		...
		NewStyle("input:focused").WithColors("$fg0", "$bg1"),
		NewStyle("typeahead").WithColors("$fg0", "$bg2").WithCursor("*bar"),
		NewStyle("typeahead:focused").WithColors("$fg0", "$bg1"),
		NewStyle("typeahead/suggestion").WithColors("$fg2", "$bg2"),
		NewStyle("typeahead/suggestion:focused").WithColors("$fg2", "$bg1"),
		NewStyle("rule"),
		...
		NewStyle("select:focused").WithColors("$fg0", "$bg1"),
