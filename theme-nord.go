...
func NordTheme() *Theme {
	...
	t.SetStyles(
		...
		NewStyle("rule"),
		NewStyle("marquee").WithColors("$frost2", "$bg0"),
		NewStyle("shimmer").WithColors("$fg2", "$bg0"),
		NewStyle("shimmer/band").WithForeground("$frost2"),
		...
		NewStyle("bar-chart/s2").WithColors("$yellow", "$bg0"),
		NewStyle("bar-chart/s3").WithColors("$red", "$bg0"),
		NewStyle("bar-chart/s4").WithColors("$purple", "$bg0"),
		NewStyle("bar-chart/s5").WithColors("$frost1", "$bg0"),
		NewStyle("bar-chart/s6").WithColors("$orange", "$bg0"),
		NewStyle("bar-chart/s7").WithColors("$frost3", "$bg0"),
		...
		NewStyle("breadcrumb/segment:focused").WithColors("$bg0", "$frost2").WithFont("bold"),
		NewStyle("breadcrumb/separator").WithColors("$bg3", "$bg0"),
		...
		NewStyle("combo:focused").WithColors("$bg0", "$frost2"),
