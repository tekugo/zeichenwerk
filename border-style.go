...
// BorderStyles provides a collection of predefined border styles for common UI design patterns.
// Each style uses Unicode box-drawing characters to create visually consistent borders
// and grid layouts. Styles range from minimal to decorative, allowing developers to
// choose appropriate visual weight for different UI contexts.
//
// Available styles:
//   - "thin": Standard single-line borders, most common and readable
//   - "double": Double-line borders for emphasis and visual hierarchy
//   - "round": Rounded corners with thin lines for modern, friendly appearance
//   - "thick": Bold single-line borders for strong visual emphasis
//   - "thick-thin": Mixed weight borders (thick outer, thin inner) for complex layouts
//   - "thick-slashed": Thick borders with dashed inner lines for subtle grid separation
//   - "lines": Minimalist top/bottom lines only, for subtle content separation
//
// Usage example:
//
//	style := widget.Style("focused")
//	style.Border = "double"  // Use double-line border style
//
// The style system automatically handles character selection based on context,
// ensuring proper connections between adjacent border elements.
