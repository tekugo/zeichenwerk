...
func (h *Heatmap) Render(r *Renderer) {
	...
	zeroFg := r.theme.Color(zeroStyle.Foreground())
	zeroBg := r.theme.Color(zeroStyle.Background())
	maxFg := r.theme.Color(maxStyle.Foreground())
	maxBg := r.theme.Color(maxStyle.Background())
